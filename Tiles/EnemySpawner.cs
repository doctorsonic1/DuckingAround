...
{
    public class EnemySpawner : ModTile
    {
        public static bool spawnActive;
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Placeable.EnemySpawner>());
            spawnActive = false;
        }
        ...
        public override void PlaceInWorld(int i, int j, Item item)
        {
            ...
            DuckingWorld.spawnerX = 16 * i;
            DuckingWorld.spawnerY = 16 * j;
        }
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            if (tile.frameY >= 56)
            {
                ...
                DuckingWorld.frameInt = tile.frameY;
            }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.showItemIcon2 = ModContent.ItemType<Items.Placeable.EnemySpawner>();
        }
