...
namespace DuckingAround.Projectiles.Yoyos.Orbiting.Freedom
{
    public class FreedomOrbiting3 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!projectile.active || projectile.type != ModContent.ProjectileType<FreedomProj>() || projectile.owner != this.projectile.owner)
            {
