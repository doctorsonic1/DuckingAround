...
namespace DuckingAround.Projectiles.Yoyos.Orbiting.Bountyhunter
{
    public class BountyOrbiting2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!projectile.active || projectile.type != ModContent.ProjectileType<BountyHunterProj>() || projectile.owner != this.projectile.owner)
            {
