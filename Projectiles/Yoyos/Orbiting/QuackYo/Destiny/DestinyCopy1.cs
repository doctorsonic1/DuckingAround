...
namespace DuckingAround.Projectiles.Yoyos.Orbiting.QuackYo.Destiny
{
    public class DestinyCopy1 : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            if (60 > frameCounter && frameCounter > 30)
            { projectile.frame = 1; }

            if (90 > frameCounter && frameCounter > 60)
            { projectile.frame = 2; }

            if (120 > frameCounter && frameCounter > 90)
            { projectile.frame = 3; }
