...
namespace DuckingAround.Projectiles.Yoyos.Orbiting.Pegasus
{
    public class PegasusOrbiting1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (!projectile.active || projectile.type != ModContent.ProjectileType<PegasusProj>() || projectile.owner != this.projectile.owner)
            {
